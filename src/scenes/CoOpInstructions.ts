...
export default class CoOpInstructions extends Phaser.Scene {
  constructor() {
    super("coOpInstructions");
  }

  preload() {
    this.load.image("coOpInstructions", "./assets/coOpInstructions.png");
  ...
  create() {
    ...
    const playButton = this.add
      .sprite(width * 0.53, height * 0.84, "play_button")
      .setInteractive()
