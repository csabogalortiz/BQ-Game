...
export default class FarmerLevel extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "farmBox",
      "./assets/farmBox_sprite_sheet.png",
      "./assets/farmBox_sprite_sheet.json"
    );
    this.load.atlas(
      "farmers",
      "./assets/happy_farmer_sprite_sheet.png",
      "./assets/happy_farmer_sprite_sheet.json"
    );
    this.load.atlas(
      "bqPower",
    ...
    this.load.atlas(
      "cryFarmer",
      "./assets/cry_farmer_sprite_sheet.png",
      "./assets/cry_farmer_sprite_sheet.json"
    );
    this.load.atlas(
      "blueBox",
      "./assets/blueBox_sprite_sheet.png",
      "./assets/blueBox_sprite_sheet.json"
    );
    this.load.atlas(
      "fertilizerFarmer",
      "./assets/fertilizer_farmer_sprite_sheet.png",
      "./assets/fertilizer_farmer_sprite_sheet.json"
    );
    ...
    objectsLayer.objects.forEach((objData) => {
      ...
      switch (name) {
        ...
        case "fertilizerFarmer": {
          const fertilizerFarmer = this.matter.add
            .sprite(x, y, "fertilizerFarmer")
            .setFixedRotation();

          this.fertilizerFarmer.push(
            new FertilizerFarmerController(this, fertilizerFarmer)
          );
          this.obstacles.add(
            "fertilizerFarmer",
            fertilizerFarmer.body as MatterJS.BodyType
          );
          break;
        }

        case "cryFarmer": {
          const cryFarmer = this.matter.add
            .sprite(x, y, "cryFarmer")
            .setFixedRotation();
        ...
        case "farmSign": {
          const farmSign = this.matter.add
            .sprite(x, y + (height - 50), "farmSign", undefined, {
              isStatic: true,
              isSensor: true,
            })
            .setFixedRotation();
        ...
        case "bqPowerSign": {
          const bqPowerSign = this.matter.add
            .sprite(x, y + (height - 50), "bqPowerSign", undefined, {
              isStatic: true,
              isSensor: true,
            })
            .setFixedRotation();
          ...
          this.obstacles.add(
            "bqPowerSign",
            bqPowerSign.body as MatterJS.BodyType
          );
          break;
        }
        ...
        case "stump": {
          const farmSign = this.matter.add
            .sprite(x, y + (height - 30), "stump", undefined, {
              isStatic: true,
              isSensor: true,
            })
            .setFixedRotation();
        ...
        case "farmBox": {
          const farmBox = this.matter.add
            .sprite(x + (width - 39), y + (height - 38), "farmBox", undefined, {
              isStatic: true,
              isSensor: true,
            })
        ...
        case "blueBox": {
          const blueBox = this.matter.add
            .sprite(x + (width - 39), y + (height - 38), "blueBox", undefined, {
              isStatic: true,
              isSensor: true,
            })
        ...
        case "bqPower": {
          const bqPower = this.matter.add
            .sprite(x + (width - 39), y + (height - 38), "bqPower", undefined, {
              isStatic: true,
              isSensor: true,
            })
            .setFixedRotation();
        ...
        case "ohnoFarm": {
          const ohnoFarm = this.matter.add.rectangle(
            x + width * 0.5,
            y + height * 0.5,
            width,
            height,
        ...
        case "ohnoWater": {
          const ohnoWater = this.matter.add.rectangle(
            x + width * 0.5,
            y + height * 0.5,
            width,
            height,
        ...
        case "ohnoDeforest": {
          const ohnoDeforest = this.matter.add.rectangle(
            x + width * 0.5,
            y + height * 0.5,
            width,
            height,
        ...
        case "ohnoRadio": {
          const ohnoRadio = this.matter.add.rectangle(
            x + width * 0.5,
            y + height * 0.5,
            width,
            height,
        ...
        case "nonCompliantLand": {
          const nonCompliantLand = this.matter.add.rectangle(
            x + width * 0.5,
            y + height * 0.5,
            width,
            height,
  ...
  update(t: number, dt: number) {
    ...
    this.fertilizerFarmer.forEach((fertilizerFarmer) =>
      fertilizerFarmer.update(dt)
    );
